...
import styles from "../SCSScomponents/AccountConfirmation.module.scss"
...
function AccountConfirmation() {
    ...
    const confirmAccount = async (e) => {
        ...
        try{
            const response = await fetch(`${process.env.REACT_APP_API}api/auth/account/confirm`, {
                method: "POST",
                mode: "cors",
                headers: {
    ...
    const resendConfirmationCode = async (e) => {
        ...
        try{
            const response = await fetch(`${process.env.REACT_APP_API}api/auth/account/resend-confirmation-code`, {
                method: "POST",
                mode: "cors",
                headers: {
                    "Content-Type": "application/json"
